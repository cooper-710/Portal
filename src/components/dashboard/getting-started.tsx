...
export function GettingStartedChecklist({
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-blue-200/70 bg-gradient-to-br from-blue-50/80 via-white to-white shadow-sm">
      <div className="border-b border-blue-100/80 px-4 py-4 sm:px-5">
